...
ENABLE_F_MENU                 ?= 1
ENABLE_AUTO_SET_MODE_DEF      ?= 1
ENABLE_DEVIATION              ?= 1
ENABLE_CW_MODULATION          ?= 1
ENABLE_EXPERIMENTAL_BW_FILTER ?= 1
...
ifeq ($(ENABLE_TX_1240_BAND),1)
	CFLAGS  += -DENABLE_TX_1240_BAND
endif
ifeq ($(ENABLE_WIDE_INPUTBOX),1)
	CFLAGS  += -DENABLE_WIDE_INPUTBOX
endif
ifeq ($(ENABLE_F_MENU),1)
	CFLAGS  += -DENABLE_F_MENU
endif
ifeq ($(ENABLE_AUTO_SET_MODE_DEF),1)
	CFLAGS  += -DENABLE_AUTO_SET_MODE_DEF
endif
...
ifeq ($(ENABLE_EXPERIMENTAL_BW_FILTER),1)
	CFLAGS  += -DENABLE_EXPERIMENTAL_BW_FILTER
endif
